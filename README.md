...
Проект API_REVIEWS_3 собирает отзывы пользователей на произведения. Сами произведения в API_REVIEWS_3 не хранятся, здесь нельзя посмотреть фильм или послушать музыку.
...
```
git clone git@github.com:dimoniiio/api_reviews_3.git
```
